                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center!important;">USUÁRIOS</th>
                                    ...
                                    <tbody>
                                     <c:forEach items="${usuarios}" var="usuario">
                                        <tr class="odd gradeX">
                                            <td style="text-align: center!important;">${usuario.login}</td>
									      	<%--<td align="center" class="center"><a class="btn btn-primary" href="mostraUsuario?id=${usuario.login}"><i class="fa fa-edit"></i> Alterar</a></td> --%>
     									     <td align="center" class="center"><a class="btn btn-default" href="removeUsuario?id=${usuario.login}}"><i class="fa fa-trash"></i> Remover</a></td>  
                                        </tr>
                                     </c:forEach> 
                                    </tbody>
                                </table>

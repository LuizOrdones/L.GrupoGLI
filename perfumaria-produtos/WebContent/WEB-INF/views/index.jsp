            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#" class="active"><i class="fa fa-dashboard fa-fw"></i> Painel</a>
                        </li>
                        <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-yellow">
                        ...
                        <a href="#">
                            <div class="panel-footer">
                                <span class="pull-left">Acessar o Estoque</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-envelope fa-fw"></i> Nova Menssagem
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-upload fa-fw"></i> Produto Inserido
                                    <span class="pull-right text-muted small"><em>11:32 AM</em>
                                    </span>
                                </a>
                            </div><!-- /.list-group -->
                            <a href="#" class="btn btn-default btn-block">Veja todos os alertas</a>
                        </div><!-- /.panel-body -->
                    </div>
                </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
